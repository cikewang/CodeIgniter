...
$config['mongo_user']            = 'pbi_video';
$config['mongo_pass']            = 'pbi_123456#';
$config['mongo_db']              = 'pbi_video';
$config['mongo_replicaset']      = FALSE;
$config['mongo_slave_ok']        = FALSE;
$config['mongo_write_timeout']   = 5000;
$config['mongo_ensure_replicas'] = 1;
$config['mongo_update_all']      = FALSE;
$config['mongo_remove_all']      = FALSE;
$config['mongo_use_upsert']      = FALSE;
$config['mongo_expand_dbrefs']   = FALSE;
