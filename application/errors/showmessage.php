...
<title><?php echo lang('showmessage.prompt');?></title>
<style type="text/css">
...
.showMsg h5{background-image: url(<?php echo base_url();?>statics/images/msg_img/msg.png);background-repeat: no-repeat; color:#fff; padding-left:35px; height:25px; line-height:26px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left}
.showMsg .content{ padding:46px 12px 10px 45px; font-size:14px; height:66px;}
.showMsg .bottom{ background:#e4ecf7; margin: 0 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center}
.showMsg .ok,.showMsg .guery{background: url(<?php echo base_url();?>statics/images/msg_img/msg_bg.png) no-repeat 0px -560px;}
...
<div class="showMsg" style="text-align:center">
	<h5><?php echo lang('showmessage.prompt');?></h5>
	...
	<?php if($url_forward =='goback' || $url_forward == '') { ?>
		<a href="javascript:history.back();" ><?php echo lang('showmessage.back');?></a>
	<?php } elseif($url_forward == 'close') { ?>
		<input type="button" name="close" value="<?php echo lang('showmessage.close');?> " onClick="window.close();">
	<?php } elseif ($url_forward != '') { ?>
		<a href="<?php echo $url_forward;?>"><?php echo lang('showmessage.forward');?></a>
